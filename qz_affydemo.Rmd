...
## get data
The data is downloaded via `GEOquery` package, SOFT files are downloaded mannually into this directory.
...
# set this path to which contains the soft file, [gz] is acceptable
